...
public class ChooseYourOwnAdventure
{
  ...
  private static void approachOoze()
  {
    ...
    if ("toilet".equalsIgnoreCase(toiletOrBackyard))
    {
      pourIntoToilet();
    }
    else if ("backyard".equalsIgnoreCase(toiletOrBackyard))
    {
      pourIntoBackyard();
    }
    else
  ...
  private static void pourIntoToilet()
  {
    ...
    String yesOrHeckYes = MessageBox.askForTextInput("Do you want to train to be a NINJA?   'Yes' or 'HECK YES'?");
    if ("Yes".equalsIgnoreCase(yesOrHeckYes))
    {
      MessageBox
          .showMessage("Awesome dude!  You live out the rest of your life fighting crimes and eating pizza!");
    }
    else if ("HECK YES".equalsIgnoreCase(yesOrHeckYes))
    {
      MessageBox
          .showMessage("Awesome dude!  You live out the rest of your life fighting crimes and eating pizza!");
    }
