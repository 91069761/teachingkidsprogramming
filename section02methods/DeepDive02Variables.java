...
public class DeepDive02Variables
{
  ...
  public void peopleInClass() throws Exception
  {
    int people = 30;
    int classes = people / 3;
    Assert.assertEquals(10, classes);
  }
  public void methodsCanReturnValuesAndVariablesexistWithinMethods() throws Exception
  {
    String exam = "work";
    exam = life();
